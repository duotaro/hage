...
const FIREBASE_AUYH_DOMAIN = process.env.NEXT_PUBLIC_FIREBASE_AUYH_DOMAIN || process.env.FIREBASE_AUYH_DOMAIN
...
const FIREBASE_MESSAGEING_SENDER_ID = process.env.NEXT_PUBLIC_FIREBASE_MESSAGEING_SENDER_ID || process.env.FIREBASE_MESSAGEING_SENDER_ID
const FIREBASE_APP_ID = process.env.NEXT_PUBLIC_FIREBASE_APP_ID || process.env.FIREBASE_APP_ID
const PIXABAY_API_KEY = process.env.NEXT_PUBLIC_PIXABAY_API_KEY || process.env.PIXABAY_API_KEY
